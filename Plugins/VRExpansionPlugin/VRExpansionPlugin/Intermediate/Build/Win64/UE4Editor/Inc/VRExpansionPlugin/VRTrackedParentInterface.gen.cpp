...
// End Cross Module References
	...
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UVRTrackedParentInterface_SetTrackedParent_Statics::NewProp_WaistTrackingMode = { UE4CodeGen_Private::EPropertyClass::Enum, "WaistTrackingMode", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000080, 1, nullptr, STRUCT_OFFSET(VRTrackedParentInterface_eventSetTrackedParent_Parms, WaistTrackingMode), Z_Construct_UEnum_VRExpansionPlugin_EBPVRWaistTrackingMode, METADATA_PARAMS(nullptr, 0) };
	...
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UVRTrackedParentInterface_SetTrackedParent_Statics::NewProp_WaistRadius = { UE4CodeGen_Private::EPropertyClass::Float, "WaistRadius", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000080, 1, nullptr, STRUCT_OFFSET(VRTrackedParentInterface_eventSetTrackedParent_Parms, WaistRadius), METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UVRTrackedParentInterface_SetTrackedParent_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UVRTrackedParentInterface, "SetTrackedParent", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x04020400, sizeof(VRTrackedParentInterface_eventSetTrackedParent_Parms), Z_Construct_UFunction_UVRTrackedParentInterface_SetTrackedParent_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_UVRTrackedParentInterface_SetTrackedParent_Statics::PropPointers), 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UVRTrackedParentInterface_SetTrackedParent_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_UVRTrackedParentInterface_SetTrackedParent_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UVRTrackedParentInterface_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UVRTrackedParentInterface_SetTrackedParent, "SetTrackedParent" }, // 2394316649
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UVRTrackedParentInterface, 50234767);
